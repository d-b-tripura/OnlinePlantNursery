...
public class Plant extends Product{
	...
	public Plant(int pId, String productName, String description, Integer plantHeight, Integer plantsStock, String commonName, String bloomTime,
			String medicinalOrCulinaryUse, String difficultyLevel, String temparature, String typeOfPlant,
			String plantSpread, double plantCost) {
	...
	public String toString() {
		return "Plant [plantHeight=" + plantHeight + ", plantSpread=" + plantSpread
				...
				+ ", typeOfPlant=" + typeOfPlant + ", plantsStock="
