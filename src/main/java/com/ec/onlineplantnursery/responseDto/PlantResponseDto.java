...
public class PlantResponseDto {
	...
	public String toString() {
		return "PlantResponseDto [pId=" + pId + ", productName=" + productName + ", plantHeight=" + plantHeight
				...
				+ ", temparature=" + temparature + ", typeOfPlant=" + typeOfPlant + ", plantStock=" + plantStock + ", plantCost=" + plantCost + "]";
	}
