...
public class PlantRequestDto {
	...
	public PlantRequestDto(int pId, String productName, String description, @Positive(message = "Height of plant should be positive") Integer plantHeight,
	...
	public String toString() {
		return "PlantRequestDto [pId=" + pId + ", productName=" + productName + ", plantHeight=" + plantHeight
				+ ", plantSpread=" + plantSpread + ", commonName=" + commonName + ", bloomTime=" + bloomTime
				+ ", medicinalOrCulinaryUse=" + medicinalOrCulinaryUse + ", difficultyLevel=" + difficultyLevel
				+ ", temparature=" + temparature + ", typeOfPlant=" + typeOfPlant + ", plantsStock=" + plantsStock
				+ ", plantCost=" + plantCost + ", description=" + description + "]";
	}
